...
## 予定
- 公開のための仕上げ
- 作品を再生したり、ダウンロードするURLを以下に貼り付ける
  - https://trello.com/b/BCyk2XsD/卒業制作2018 の「バグ・感想・報告」リスト
- ネットドライブやVR PCのデータのバックアップ作成
  - 休みに入ったらいつ消えてもいいように、データやログイン情報を削除すること

# 後期15回目(1/30)
## 内容
- 進捗発表(明日もあるので、軽いものでよい)
  - 就活に進捗があった人は報告
- 作品を再生したり、ダウンロードするURLを以下に貼り付ける
  - https://trello.com/b/BCyk2XsD/卒業制作2018 の「バグ・感想・報告」リスト
...
## 予定
- 正月休み中の進捗発表(明日もあるので、軽いものでよい)
  - 就活に進捗があった人は報告

# 後期10, 11回目(12/12, 19)
## 話題
- Unity1週間ゲームジャム　新年会の募集が始まってるかも
- [paizaキャンペーン中](https://paiza.jp/challenges)

## 内容
- 作業予定は明日でいいので、今回からは各自のテーマの進捗とニュースの発表をお願いします
- 発表後は作業と質疑応答


# 後期9回目(12/5)
## 話題
- [ハシラス・オープンデイ](https://hashilus.connpass.com/event/112044/)
- ブルガリアコントローラー
- 成果報告
  - [Qiita Unityアドベントカレンダー#2](https://qiita.com/advent-calendar/2018/unity2)
  - [unityroom アドベントカレンダー 2018](https://twitter.com/naichilab/status/1069613627324358656)
...
- これまでは雑多な調査とニュースの発表だったが、今後は研究テーマを設定して、それに沿った内容にしたい
  - 大学の卒業論文に該当するものが欲しい
  - 卒業制作の作品をベースで構わないので、論文に近い形式のドキュメントをまとめて発表することを目指す
  - ただし、すでに内定が出ている場合は、卒業制作や自分で知りたいことを中心としてこれまでと同じスタイルでの発表で構わない(ただし(2)、転職をする際に、手順に沿った論述の経験があるのは強みになる)

## 研究とは
世の中で明らかになっていない事について、以下のようなことを調査して明らかにすること。

- テーマの設定
- 現状がどうなっているかの調査、レポート
- 仮説の設定
- 実験、検証
- 実験や検証から、仮説がどのように説明できたかの論述
- 今後の課題
- 参考文献リスト
...
## 話題
- [ブルガリアコントローラーに対応できるゲームの募集](https://twitter.com/ni26mu/status/1055088599878647808)
  - プレゼントは無くなった模様だが、1週間ゲームジャム新年会などに向けて活動するのはありそう
- [Visual Effect Graph - Realtime visual effects In Unity 2018.3](https://youtu.be/SUZzJcBIK80)
- [Unity1週間ゲームジャム新年会について、いただいたコメント](https://twitter.com/lycoris102/status/1056183914794864641)

## 予定
- 来週は手伝えないので、今週中に不明点を解決しておくこと


# 後期4回目
## 話題
- デジゲー博、ポスターと配布シール50枚を発注した
- デジゲー博のお手伝い募集
  - 展示手伝い1名+カタログで入場できる1名
  - [カタログ前売り](https://twitter.com/DigiGameExpo/status/1051744013630418944)
...
## 話題
- [ここが楽しい/しんどい Live2D Cubism SDK for Unity](https://t.co/oOmtWQ6c94?amp=1)
...
## 話題
- [codic. 日本語で入力した文から、関数名や変数名の候補を示してくれるサービス](https://codic.jp/)
...
- 前期の成果物。完成して、発表したものリスト
- 就職活動まとめ(応募、面接、内定など、完了したものについて。公表したくない場合は書面で提出)
...
- [Weeyble. Unity３Hカジュアルゲームハッカソン](https://weeyble-game.connpass.com/event/94407/?utm_campaign=event_publish_to_follower&utm_medium=twitter&utm_source=notifications)
  - https://mobile.twitter.com/hashtag/3HCG?src=hashtag_click&f=live
...
- ポートフォリオに進捗があれば
- 就活報告
- (GitLabの手順調査中で、そちらでやることを検討なので少し保留)BitBucketによるプライベートリポジトリーの作成と、チーム開発の手順
...
## Unity1週間ゲームジャムまとめ
- unityroomの自分のゲームに`デジタルアーツ東京`のタグを追加する
  - 強制ではありませんが、外で学生さんの作品は？と質問されたときにこのタグを紹介しようと思うので、つけない場合は機会損失します
- 以下、Googleドキュメントにまとめて、リンクを知らせる
  - 分量：半ページ
  - ゲームタイトル
  - 画像1枚～2枚程度(印刷するのでアニメは不可)
  - ゲーム概要
  - 共有リンクのURLをTrelloの「Unity1週間ゲームジャムギリギリの作品＆ドキュメント」にコメントで
...
## 話題
- [ユニティリレーゲーム開発](https://mobile.twitter.com/PonixNews/status/1005994836355190784)
- [ボクセルゲームを試作するプロジェクト](https://mobile.twitter.com/urabe_rocinante/status/996975668243062791)
